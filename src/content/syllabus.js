...
export const PICK_TEXT = {
  kicker: 'SCHEDULE',
  title: 'برنامه‌ی کارگاه‌ها',
  // عمداً هیچ عددی از «هفته» نمی‌گوید. جمله‌ی قبلی می‌گفت «در چهار هفته … دو تا در هفته»
  // و همان روزی که یک تاریخ عوض شد، غلط شد. چیزی که ثابت است هشت کارگاه و دو تا برای هر
  // تیم است؛ تقویم را جدول پایین می‌گوید.
  body:
    'هشت سرفصل و چهار تیم: به هر تیم دو موضوع رسیده و هر هشت کارگاه، یکشنبه‌ها و سه‌شنبه‌ها، برگزار می‌شود.',
  slotTitle: 'هشت کارگاه',
  // ساعت برای هر هشت کارگاه یکی است، پس یک بار گفته می‌شود و روی هر ایستگاه هم تکرار
  // می‌شود — کسی که فقط تاریخِ نوبت خودش را نگاه می‌کند نباید مجبور باشد دنبال ساعت بگردد.
  clock: '۶ عصر',
  timeNote: 'هر هشت کارگاه ساعت ۶ عصر شروع می‌شوند.',
};

// اولین نوبت. بقیه‌ی تاریخ‌ها در SCHEDULE از روی همین چیده شده‌اند، ولی صریح آمده‌اند تا
// خواندن فایل نیاز به حساب‌کردن نداشته باشد.
export const TALKS_START = '2026-09-01';

// قرعه یک بار انجام شده و این‌جا ثابت است. اگر موقع رندر با تصادف ساخته می‌شد، هر بار
// بازکردن صفحه جواب دیگری می‌داد و هیچ‌کس نمی‌توانست به آن استناد کند.
//
// `teamId` همان شناسه‌ی تیم در people.js است، نه اسمش — اسم عوض می‌شود، شناسه نه.
//
// شروع روی سه‌شنبه ۱۰ شهریور است و از آن‌جا هر هفته یک سه‌شنبه و یک یکشنبه، بدون جای خالی.
// چون کل برنامه بعد از تعطیلیِ ۸ شهریور شروع می‌شود، آن جابه‌جایی و دو بی‌قاعدگی‌اش دیگر
// موضوعیت ندارند: هیچ یکشنبه‌ای وسط برنامه جا نیفتاده و هر چهار تیم دوباره یک یکشنبه و
// یک سه‌شنبه دارند.
export const SCHEDULE = [
  { n: 1, date: '2026-09-01', teamId: 'nimbus', topicId: 'kafka' },
  { n: 2, date: '2026-09-06', teamId: 'stratus', topicId: 'build' },
  { n: 3, date: '2026-09-08', teamId: 'cirrus', topicId: 'spring' },
  { n: 4, date: '2026-09-13', teamId: 'cumulus', topicId: 'sql' },
  { n: 5, date: '2026-09-15', teamId: 'stratus', topicId: 'monitoring' },
  { n: 6, date: '2026-09-20', teamId: 'cirrus', topicId: 'ansible' },
  { n: 7, date: '2026-09-22', teamId: 'cumulus', topicId: 'k8s' },
  { n: 8, date: '2026-09-27', teamId: 'nimbus', topicId: 'spark' },
];

export const MODEL_TEXT = {
  kicker: 'MENTAL MODEL',
  title: 'محکِ اینکه کارگاه گرفت یا نه',
  // این جمله حرفِ خودِ سایت است با بچه‌ها، نه محتوای سرفصل — پس فارسی است، مثل بقیه‌ی
  // قاب صفحه. سرفصل‌های خود موضوع‌ها انگلیسی می‌مانند.
  body:
    'بعد از هر کارگاه، شنونده باید بتواند مدل ذهنی مفاهیم آن تکنولوژی را روی کاغذ بکشد. اگر نتواند، آن کارگاه اطلاعات داده ولی مدل نساخته است. دو نمونه:',
};
