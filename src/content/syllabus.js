...
export const PICK_TEXT = {
  ...
  body:
    'هشت سرفصل هست و چهار تیم. به هر تیم دو موضوع داده می‌شود — یعنی هر هشت سرفصل دقیقاً یک بار پوشش داده می‌شود و هیچ موضوعی روی زمین نمی‌ماند.',
  timing: 'موضوعِ هر تیم و زمان ارائه‌اش را بعداً اعلام می‌کنیم.',
  rules: [
    'موضوع‌ها را ما تقسیم می‌کنیم، نه اینکه خودتان بردارید. دلیلش هم همین است: یکی از دو موضوع هر تیم عمداً چیزی است که هنوز بلد نیستید.',
