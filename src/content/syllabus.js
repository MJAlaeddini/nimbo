...
export const PICK_TEXT = {
  ...
  // و همان روزی که یک تاریخ عوض شد، غلط شد. چیزی که ثابت است هشت ارائه و دو تا برای هر
  // تیم است؛ تقویم را جدول پایین می‌گوید.
  body:
    'هشت سرفصل و چهار تیم: به هر تیم دو موضوع رسیده و هر هشت ارائه، یکشنبه‌ها و سه‌شنبه‌ها، برگزار می‌شود.',
  slotTitle: 'هشت ارائه',
  // ساعت برای هر هشت ارائه یکی است، پس یک بار گفته می‌شود و روی هر ایستگاه هم تکرار
  // می‌شود — کسی که فقط تاریخِ نوبت خودش را نگاه می‌کند نباید مجبور باشد دنبال ساعت بگردد.
  clock: '۶ عصر',
  timeNote: 'هر هشت ارائه ساعت ۶ عصر شروع می‌شوند.',
};

// اولین یکشنبه. بقیه‌ی تاریخ‌ها در SCHEDULE از روی همین نوشته شده‌اند، ولی صریح آمده‌اند تا
// خواندن فایل نیاز به حساب‌کردن نداشته باشد.
export const TALKS_START = '2026-08-23';
...
//
// یکشنبه‌ی ۸ شهریور (۲۰۲۶-۰۸-۳۰) تعطیل است، پس از اسلات سوم به بعد همه یکی عقب رفته‌اند.
// دو بی‌قاعدگی که از آن مانده عمدی‌اند و «تمیز» کردنشان یعنی برگرداندن ارائه به یک روز
// تعطیل:
//   — وسط برنامه یک یکشنبه جا افتاده (بین ۳ و ۱۰ شهریور)
//   — قاعده‌ی «هر تیم یک یکشنبه و یک سه‌شنبه» دیگر برقرار نیست: TMNT دو یکشنبه دارد و
//     AAA دو سه‌شنبه. ترتیب تیم‌ها اما دست نخورده، پس هنوز هیچ تیمی دو نوبت پشت‌سرهم
//     ندارد و تیم اول همان تیم آخر است.
export const SCHEDULE = [
  { n: 1, date: '2026-08-23', teamId: 'nimbus', topicId: 'kafka' },
  { n: 2, date: '2026-08-25', teamId: 'stratus', topicId: 'build' },
  { n: 3, date: '2026-09-01', teamId: 'cirrus', topicId: 'spring' },
  { n: 4, date: '2026-09-06', teamId: 'cumulus', topicId: 'sql' },
  { n: 5, date: '2026-09-08', teamId: 'stratus', topicId: 'monitoring' },
  { n: 6, date: '2026-09-13', teamId: 'cirrus', topicId: 'ansible' },
  { n: 7, date: '2026-09-15', teamId: 'cumulus', topicId: 'k8s' },
  { n: 8, date: '2026-09-20', teamId: 'nimbus', topicId: 'spark' },
];
